            ...
            <ScrollArea className="w-full whitespace-nowrap rounded-md pb-4">
                <div className="flex w-max space-x-6 p-4">
                    {slides.map((slide, index) => (
                        <div
                            key={slide.id}
                            className="relative aspect-[4/5] w-[320px] shrink-0 overflow-hidden rounded-none bg-white shadow-xl border border-neutral-100 flex flex-col p-8 select-none"
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div className="flex flex-col leading-tight">
                                    ...
                                    <span className="text-xs text-neutral-500 font-medium">@{user?.name?.toLowerCase().replace(/\s+/g, '') || "handle"}</span>
                                </div>
                            </div>
                            ...
                            {index < slides.length - 1 && (
                                <div className="absolute right-4 top-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-neutral-100 p-2 text-neutral-400 opacity-50 hover:opacity-100 hidden group-hover:flex">
